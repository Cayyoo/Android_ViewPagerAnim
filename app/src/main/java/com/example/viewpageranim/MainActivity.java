...
import com.example.viewpageranim.modify_source_code_anim.ModifiedOfficialViewPager;
...
public class MainActivity extends Activity {
	...
	private ModifiedOfficialViewPager mViewPager;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mViewPager=(ModifiedOfficialViewPager) findViewById(R.id.id_viewpager);
